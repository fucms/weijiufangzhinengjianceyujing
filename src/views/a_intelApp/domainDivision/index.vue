    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="管理员ID">
          <el-input v-model="listQuery.filter" placeholder="请输入管理员ID" />
        </el-form-item>
        <el-form-item label="管理员姓名">
          <el-input v-model="listQuery.filter" placeholder="请输入管理员姓名" />
        </el-form-item>
        <el-form-item>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="管理员ID" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code1 }}</span>
          </template>
        </el-table-column>
        <el-table-column label="管理员姓名" prop="type3" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code2 }}</span>
          </template>
        </el-table-column>
